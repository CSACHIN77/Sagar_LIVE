...
import sys
class Strategy:
    def __init__(self, xts, name: str, socket, index: str, underlying: str, strategy_type: str, entry_time: datetime, 
        ...
        # print(f"index_ex_id , {self.index_ex_id}")
        print('still working')
    ...
    def get_underlying_ltp(self) -> float:
            ...
            try:
                if self.underlying.lower() == 'spot':
                    ...
                    data = self.xts.get_quotes([self.index_ex_id], self.soc)
                    print(f"get quotes {data}")
